...
/**
 * Pomoci PrikazZamkni lze zamknout danou mistnost, paklize ma od ni hrac klic
 * 
 * @author Pavel Jurca, xjurp20@vse.cz
 * @version 2
 */
public class PrikazZamkni extends Prikaz {

    public PrikazZamkni(Hra hra, String popis) {
        super(hra, popis);
    }
    ...
    public boolean proved(String[] parametry) {
        if (null == parametry
            ...
            result = " err: dobre, zamkni, ale co?";
            return false;
        }
        ...
        switch (parametry.length) {
            case 1:
                ...
                if (prostor != null) {
                    //lze zamknout i mistnost, ve ktere prave jste
                        ...
                        if (prostor.lzeZamknout()) {
                            if (!prostor.isZamknuto()) {
                                ...
                                if (klic != null) {
                                    ...
                                    result = " neuspech: od prostoru "
                                            + prostor + " musite mit klic";
                                }
                            } else {
    ...
    public String toString() {
        return PrikazyVycet.ZAMKNI.toString();
    }
}
